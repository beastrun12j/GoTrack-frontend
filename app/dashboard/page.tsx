...
const Dashboard = async () => {
  ...
  return (
      <>
          <div className="main grid grid-cols-10 gap-4 mt-10">

            <div className="hidden md:block  md:mr-5 md:col-span-1">

            </div>
    
            <div className="hidden md:block  md:mr-5 md:col-span-3">
              <Alerts />
            </div>
            ...
            <div className="ml-5 col-span-4 ">
              ...
              <div className="user mt-8 ml-2">
                ...
                <div className="Projects grid grid-cols-4 gap-4">
                  ...
                  <div className="project m-5 p-2 text-center flex flex-col items-center hover:bg-sky-100">
                    <button className="cursor-pointer">
                      ...
                      <Image src="https://logos-world.net/wp-content/uploads/2023/11/Confluence-Symbol.png" alt="plus" width={100} height={100} unoptimized/>
                      <p>Confluence</p>
                    </button>
                  </div>
                  ...
                  <div className="project m-5 p-2  text-center flex flex-col items-center hover:bg-sky-100">
                    <button className="cursor-pointer">
                      <Image src={DefaultImage} alt="plus" width={100} height={100} />
                      <p>Trend Spotter</p>
                    </button>
                  </div>
