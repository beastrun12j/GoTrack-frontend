...
import {GetOrganisationByUser, GetProjectsForUserOrganisation} from "@/lib/UserActions";
              ...
              <div className="user mt-8 ml-2">
                ...
                <div className="Projects grid grid-cols-2 md:grid-cols-4 gap-4">
                  ...
                  {projects?.map((project : Project, projectid: number) => (
                    <div key={projectid} className="project m-5 p-2 text-center flex flex-col items-center hover:bg-sky-100">
