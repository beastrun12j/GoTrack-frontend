        ...
        <div className="main grid grid-cols-6 gap-4">
          ...
          <div className="ml-5 col-span-3 ">
            <div className="header">
              ...
              <h3 className='text-4xl font-bold mb-2'>Good morning UserName!</h3>
              ...
              <div className="Projects grid grid-cols-4 gap-4">
                ...
                <div className="project m-5 p-2 text-center flex flex-col items-center hover:bg-sky-100">
                  <button className="cursor-pointer">
                    ...
                    <Image src="https://cdn-icons-png.flaticon.com/512/5968/5968793.png" alt="plus" width={100} height={100} unoptimized/>
                    <p>confluence</p>
                  </button>
                </div>
